/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --path worker-configuration.d.ts` (hash: 603a59a0140ca5502afc11fe015c375c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "BACKEND_URL" | "VITE_CLERK_PUBLISHABLE_KEY" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST" | "VITE_BACKEND_URL">> {}
}
