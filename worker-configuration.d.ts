/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --path worker-configuration.d.ts` (hash: 5d576a87cfc339806eb26fca4f10d2d5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "VITE_CLERK_PUBLISHABLE_KEY" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST">> {}
}
