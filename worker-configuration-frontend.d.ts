/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.toml --path worker-configuration-frontend.d.ts` (hash: bb3bad5e10d53ae91db4e832dc4e4d80)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_URL" | "VITE_BACKEND_URL" | "DATABASE_URL" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "OPENAI_API_KEY" | "HEYGEN_API_KEY" | "DEEPGRAM_API_KEY" | "GEMINI_API_KEY" | "GOOGLE_CREDENTIALS_JSON" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST" | "NODE_ENV">> {}
}
