/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.backend.toml --path worker-configuration-backend.d.ts` (hash: 75cb42b908faded4aed80e90fe5551ac)
// Runtime types generated with workerd@1.20251202.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/backend");
	}
	interface Env {
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "OPENAI_API_KEY" | "HEYGEN_API_KEY" | "DEEPGRAM_API_KEY" | "GEMINI_API_KEY" | "GOOGLE_CREDENTIALS_JSON" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST" | "NODE_ENV">> {}
}
