/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.server.jsonc --path worker-configuration-server.d.ts` (hash: e8a4c6e96b68986bf940f43013b9d250)
