/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config app/server/workers/wrangler.jsonc --path worker-configuration-server.d.ts` (hash: f9f8eb38725840053a65450d1cc0c131)
// Runtime types generated with workerd@1.20251217.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./app/server/workers/server");
	}
	interface Env {
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "NODE_ENV">> {}
}
