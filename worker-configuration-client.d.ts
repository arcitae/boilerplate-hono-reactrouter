/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.client.jsonc --path worker-configuration-client.d.ts` (hash: bf799fae80cfb622522da04f562c46b8)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/client");
	}
	interface Env {
		DATABASE_URL: string;
