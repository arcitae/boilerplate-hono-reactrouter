/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config app/client/workers/wrangler.jsonc --path worker-configuration-client.d.ts` (hash: 24fa122c340e3ff1fa7702e5f8f783ec)
// Runtime types generated with workerd@1.20251217.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./app/client/workers/client");
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST" | "NODE_ENV">> {}
}
